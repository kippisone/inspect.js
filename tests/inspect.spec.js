...
describe('Inspect', function() {
  ...
  describe('isClass', function() {
    it('Should inspect that "foo" is a class', shouldFail('isClass', 'foo'));
    it('Should inspect that "" is a class', shouldFail('isClass', ''));
    it('Should inspect that "123" is NaN', shouldFail('isClass', '123'));
    it('Should inspect that null is a class', shouldFail('isClass', null));
    it('Should inspect that undefined is a class', shouldFail('isClass', undefined));
    it('Should inspect that true is a class', shouldFail('isClass', true));
    it('Should inspect that false is a class', shouldFail('isClass', false));
    it('Should inspect that 123 is a class', shouldFail('isClass', 123));
    it('Should inspect that 1.003 is a class', shouldFail('isClass', 1.003));
    it('Should inspect that NaN is a class', shouldFail('isClass', NaN));
    it('Should inspect that [] is a class', shouldFail('isClass', []));
    it('Should inspect that {} is a class', shouldFail('isClass', {}));
    it('Should inspect that function is a class', shouldPass('isClass', function() {}));
    it('Should inspect that generator is a class', shouldFail('isClass', function* () { yield;}));
    it('Should inspect that class is a class', shouldPass('isClass', classMethod));
    it('Should inspect that /.+/ is a class', shouldFail('isClass', /.+/));
  });

  describe('isNotClass', function() {
    it('Should inspect that "foo" is not a class', shouldPass('isNotClass', 'foo'));
    it('Should inspect that "" is not a class', shouldPass('isNotClass', ''));
    it('Should inspect that "123" is a class', shouldPass('isNotClass', '123'));
    it('Should inspect that null is not a class', shouldPass('isNotClass', null));
    it('Should inspect that undefined is not a class', shouldPass('isNotClass', undefined));
    it('Should inspect that true is not a class', shouldPass('isNotClass', true));
    it('Should inspect that false is not a class', shouldPass('isNotClass', false));
    it('Should inspect that 123 is not a class', shouldPass('isNotClass', 123));
    it('Should inspect that 1.003 is not a class', shouldPass('isNotClass', 1.003));
    it('Should inspect that NaN is not a class', shouldPass('isNotClass', NaN));
    it('Should inspect that [] is not a class', shouldPass('isNotClass', []));
    it('Should inspect that {} is not a class', shouldPass('isNotClass', {}));
    it('Should inspect that function is not a class', shouldFail('isNotClass', function() {}));
    it('Should inspect that generator is not a class', shouldPass('isNotClass', function* () { yield;}));
    it('Should inspect that class is not a class', shouldFail('isNotClass', classMethod));
    it('Should inspect that /.+/ is not a class', shouldPass('isNotClass', /.+/));
  });
