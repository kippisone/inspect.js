...
Inspect.prototype.hasProps = function(props, message) {
  ...
  if (!utils.hasProps(this.inspectValue, props)) {
    throw new InspectionError(this, message || ('Property comparison failed!'),
      this.inspectValue,
      props
    );
  }
...
Inspect.prototype.hasNotProps = function(props, message) {
    this.validateInput('obj-types', props, 'object');
    if (utils.hasProps(this.inspectValue, props)) {
        throw new InspectionError(this, message || ('Input has one of these blacklisted properties!'),
            this.inspectValue,
            props
        );
    }
...
Inspect.prototype.hasProp = function(key, value, message) {
  ...
  if (!utils.hasDeepProp(this.inspectValue, key, value)) {
    throw new InspectionError(this, message || ('Property comparison failed!'), utils.undotify(this.inspectValue, key), value);
  }
...
Inspect.prototype.hasValue = function(value, message) {
  ...
  if (!utils.hasValues(this.inspectValue, [value])) {
    throw new InspectionError(this, message || 'Input has not all of these value!', this.inspectValue, value);
  }
...
Inspect.prototype.hasValues = function(values, message) {
  ...
  if (!utils.hasValues(this.inspectValue, values)) {
    throw new InspectionError(this, message || 'Input has not all of these values!', this.inspectValue, values);
  }
...
Inspect.prototype.hasNotValues = function(values, message) {
  this.validateInput('array', values, 'array');
  if (utils.hasValues(this.inspectValue, values)) {
    throw new InspectionError(this, message || 'Input has any of these values, but it shoud have none of them!', this.inspectValue, values);
  }
...
Inspect.prototype.hasAnyValues = function(values, message) {
  ...
  if (!utils.hasAnyValues(this.inspectValue, values)) {
    throw new InspectionError(this, message || 'Input has not any of these values!', this.inspectValue, values);
  }
...
Inspect.prototype.doesIncrease = function(prop, num, message) {
  ...
  if (num) {
    if ((a + num) !== b) {
      throw new InspectionError(this, message || ('Input should be increased by ' + num + '!'), b, a + num);
    }
  }
  else if (a >= b) {
    throw new InspectionError(this, message || ('Input should be increased!'), b, a + 1);
  }
...
Inspect.prototype.doesChange = function(prop, message) {
  ...
  if (utils.compareValues(a, b)) {
    throw new InspectionError(this, message || ('Property `' + prop + '` should be changed!'));
  }
...
Inspect.prototype.doesNotChange = function(prop, message) {
  ...
  if (!utils.compareValues(a, b)) {
    throw new InspectionError(this, message || ('Property `' + prop + '` should be changed!'), b, a);
  }
...
Inspect.prototype.doesNotIncrease = function(prop, message) {
  ...
  if (!utils.compareValues(a, b)) {
    throw new InspectionError(this, message || ('Property `' + prop + '` should not be changed!'), b, a);
  }
