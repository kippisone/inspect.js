...
inspectUtils.isClass = function(cls) {
  return this.getTypeOf(cls) === 'class';
};
...
inspectUtils.isGeneratorFunction = function(fn) {
  try {
...
inspectUtils.isAsyncFunction = function(fn) {
  try {
...
inspectUtils.getTypeOf = function(a, realType) {
  ...
  if (type === 'function') {
    if (inspectUtils.isGeneratorFunction(a)) {
      return 'generator';
    }

    if (inspectUtils.isAsyncFunction(a)) {
      return 'async';
    }
...
inspectUtils.isEmpty = function(a) {
  ...
  if (type === 'object' && a.constructor === Object.prototype.constructor && Object.keys(a).length === 0) {
    return true;
  }
